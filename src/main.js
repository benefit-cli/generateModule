...
import { xxxRegComponents, xxxRoutes, xxxStore, xxxRouterView } from './index'
import NProgress from 'nprogress'

Vue.use(xxxRegComponents)
Vue.use(baseRegComponents)
if (xxxStore) {
  for (var key in xxxStore) {
    console.log(key)
    baseStore.registerModule(key, xxxStore[key])
  }
}
